--// 🌀 NiTroHUB PRO - Final Evolution (Safety Wait Fix)
--// ✨ by NiTroHUB x Gemini (แก้ไขปัญหา "attempt to call a nil value" ด้วยการรอโหลดเกม)

-- =================================================================
-- [[ ✨ SAFETY WAIT MECHANISM ✨ ]]
-- โค้ดส่วนนี้จะบังคับให้สคริปต์รอจนกว่าเกมจะโหลดเสร็จสมบูรณ์ 100%
-- เพื่อป้องกันปัญหาการเรียกใช้ฟังก์ชันที่ยังไม่พร้อมใช้งาน
-- =================================================================
if not game:IsLoaded() then
    game.Loaded:Wait()
end
task.wait(1) -- รอเพิ่มเติมอีก 1 วินาทีเพื่อความแน่นอนสูงสุด
-- =================================================================
...
-- =================================================================
-- 🎨 GUI INTERFACE & 🕹️ CONTROLS (โค้ดส่วนนี้เหมือนเดิม)
-- =================================================================
...
logmsg("✅ NiTroHUB PRO (Safety Wait Fix) Loaded! | J = สุ่มไข่, K = เก็บกล่อง")
